...
for (array.id in 1:nrow(param_comb)) {
  ...
  for(isim in 1:Nsim) {
    ...
    GAMuT_LineKernel_temp <- 
      as.numeric(GAMuT_LineKernel_END - GAMuT_LineKernel_START,  units="secs")
    ...
    GAMuT_ProjMatrix_temp <- 
      as.numeric(GAMuT_ProjMatrix_END - GAMuT_ProjMatrix_START,  units="secs")
    GAMuT_ProjMatrix_time = c(GAMuT_ProjMatrix_time,GAMuT_ProjMatrix_temp)
  ...
  file_name_GAMuT_ProjMatrix_pvalue   <- paste("pvalue", "GAMuT_ProjMatrix", "adj", "dglm", Nsim, "subj", Nsub, "pheno", Npheno, "MAF", maf, "Gamma", gamma, "Delta", delta, "DeltaSelect", delta_select, sep = "_")
  file_name_GAMuT_LineKernel_pvalue   <- paste("pvalue", "GAMuT_LineKernel", "adj", "dglm", Nsim, "subj", Nsub, "pheno", Npheno, "MAF", maf, "Gamma", gamma, "Delta", delta, "DeltaSelect", delta_select, sep = "_")
  ...
  save(pval_GAMuT_ProjMatrix_adj_dglm, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_name_GAMuT_ProjMatrix_pvalue, ".RData", sep = ""))
  save(pval_GAMuT_LineKernel_adj_dglm, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_name_GAMuT_LineKernel_pvalue, ".RData", sep = ""))
  save(pval_SMAT_adj_dglm, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_name_SMAT_pvalue, ".RData", sep = ""))
  save(pval_CCT_adj_dglm, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_name_CCT_pvalue, ".RData", sep = ""))
  save(pval_includeXsquare_CCT_adj_dglm, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_name_includeXsquare_CCT_pvalue, ".RData", sep = ""))
  
  save(simulation_time, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_simulation_time, ".RData", sep = ""))
  save(GAMuT_ProjMatrix_time, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_GAMuT_ProjMatrix_time, ".RData", sep = ""))
  save(GAMuT_LineKernel_time, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_GAMuT_LineKernel_time, ".RData", sep = ""))
  save(SMAT_time, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_SMAT_time, ".RData", sep = ""))
  save(CCT_time, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_CCT_time, ".RData", sep = ""))
  save(CCT_includeXsquare_time, 
       file = paste("Result/New_4_6_Power_Simulation_Local_OneSim/", file_includeXsquare_CCT_time, ".RData", sep = ""))
  print(paste("This is the n th row: ", array.id))
}
