...
gamma_array  <- c(0.15)
delta_array  <- c(0.5)
delta_select_array <- c(0.1, 0.3, 0.5, 1)
Nsim         <- 1
...
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given500Subj.png",
...
gt <- tableGrob(subj1000 %>% 
                  ...
                  spread(., NphenoF, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given1000Subj.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(subj2000 %>% 
                  ...
                  spread(., NphenoF, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given2000Subj.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(subj5000 %>% 
                  ...
                  spread(., NphenoF, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given5000Subj.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(subj10000 %>% 
                  ...
                  spread(., NphenoF, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given10000Subj.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(pheno4 %>% 
                  ...
                  spread(., Nsub, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given4Pheno.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(pheno6 %>% 
                  ...
                  spread(., Nsub, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given6Pheno.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(pheno8 %>% 
                  ...
                  spread(., Nsub, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given8Pheno.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(pheno10 %>% 
                  ...
                  spread(., Nsub, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given10Pheno.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
...
gt <- tableGrob(pheno12 %>% 
                  ...
                  spread(., Nsub, mean), 
                rows = NULL, theme = ttheme_minimal())
png("Analysis/New_4_6_Power_Simulation/New_4_6_Power_Simulation_Local_OneSim/Given12Pheno.png",
    width = 1000, height = 600)
grid.arrange(g, gt, ncol = 1, heights=c(2,1))
dev.off()
