...
gen_express_cov <-function(preds,int,main_beta_g,var_beta_g,Num_off_diag,cov_beta_g,sigma_e,main_beta_z_bin,main_beta_z_con,var_beta_z_bin,var_beta_z_con,cov_beta_z_bin,cov_beta_z_con){
...
mu_vec<-int+main_beta_g*g+main_beta_z_bin*bz+main_beta_z_con*cz  # create mean vector of expression levels

Sigma_1<-diag(sigma_e+var_beta_g*g+var_beta_z_bin*bz+var_beta_z_con*cz) # create diagonal elements of variance matrix

off_diag<-cov_beta_g*g+cov_beta_z_bin*bz+cov_beta_z_con*cz # create covariance elements of variance matrix
