...
save(pval_GAMuT_adj_dglm, file = "Result/Sep132021/pval_GAMuT_adj_dglm.RData")
save(pval_SMAT_adj_dglm, file = "Result/Sep132021/pval_SMAT_adj_dglm.RData")

sum(pval_GAMuT_adj_dglm < 0.05)/length(pval_GAMuT_adj_dglm) # 0.062
sum(pval_SMAT_adj_dglm < 0.05)/length(pval_SMAT_adj_dglm) # 0.062
