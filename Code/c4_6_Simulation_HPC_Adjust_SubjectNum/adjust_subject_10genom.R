...
Nsub <- c(500, 1000, seq(5000, 50000, by = 5000)) # Number of subjects

Ngenes <- 10 # Number of genes in pathway
...
for (Nsub_i in Nsub) {
  ...
  file_name_GAMuT <- paste(Sys.Date(), "pvalue", "GAMuT", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
  file_name_SMAT <- paste(Sys.Date(), "pvalue", "SMAT", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
  file_name_CCT <- paste(Sys.Date(), "pvalue", "CCT", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
  file_time_begin <- paste(Sys.Date(), "pvalue", "time_begin", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
  file_time_end <- paste(Sys.Date(), "pvalue", "time_end", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
  file_GAMuT_time <- paste(Sys.Date(), "pvalue", "GAMuT_time", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
  file_CCT_time <- paste(Sys.Date(), "pvalue", "CCT_time", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
  file_SMAT_time <- paste(Sys.Date(), "pvalue", "SMAT_time", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, sep = "_")
