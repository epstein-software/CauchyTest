...
source('Code/c4_6_Simulation_HPC_Adjust_SubjectNum/SMAT_Code.R') 
# source code for remaining functions
source('Code/c4_6_Simulation_HPC_Adjust_SubjectNum/source_files_for_shijia.R')
...
for (Nsub_i in Nsub) {
  ...
  file_name_GAMuT <- paste(Sys.Date(), "pvalue", "GAMuT", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes,"_simple_try", sep = "_")
  file_name_SMAT <- paste(Sys.Date(), "pvalue", "SMAT", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes,"_simple_try", sep = "_")
  file_name_CCT <- paste(Sys.Date(), "pvalue", "CCT", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", Ngenes, "_simple_try", sep = "_")
  file_time_begin <- paste(Sys.Date(), "pvalue", "time_begin", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", "_simple_try", Ngenes, sep = "_")
  file_time_end <- paste(Sys.Date(), "pvalue", "time_end", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", "_simple_try", Ngenes, sep = "_")
  file_GAMuT_time <- paste(Sys.Date(), "pvalue", "GAMuT_time", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno","_simple_try",  Ngenes, sep = "_")
  file_CCT_time <- paste(Sys.Date(), "pvalue", "CCT_time", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno", "_simple_try", Ngenes, sep = "_")
  file_SMAT_time <- paste(Sys.Date(), "pvalue", "SMAT_time", "adj", "dglm", Nsim, "subj", Nsub_i, "pheno","_simple_try",  Ngenes, sep = "_")
  
  
  save(pval_GAMuT_adj_dglm, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_name_GAMuT, ".RData", sep = ""))
  save(pval_SMAT_adj_dglm, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_name_SMAT, ".RData", sep = ""))
  save(pval_CCT_adj_dglm, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_name_CCT, ".RData", sep = ""))
  save(start_time, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_time_begin, ".RData", sep = ""))
  save(end_time, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_time_end, ".RData", sep = ""))
  save(GAMuT_time, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_GAMuT_time, ".RData", sep = ""))
  save(CCT_time, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_CCT_time, ".RData", sep = ""))
  save(SMAT_time, 
       file = paste("Result/c4_6_Simulation_HPC_Adjust_SubjectNum/", file_SMAT_time, ".RData", sep = ""))
