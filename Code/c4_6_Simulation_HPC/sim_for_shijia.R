...
file_name_GAMuT <- paste(Sys.Date(), "pvalue", "GAMuT", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
file_name_SMAT <- paste(Sys.Date(), "pvalue", "SMAT", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
file_name_CCT <- paste(Sys.Date(), "pvalue", "CCT", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
file_time_begin <- paste(Sys.Date(), "pvalue", "time_begin", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
file_time_end <- paste(Sys.Date(), "pvalue", "time_end", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
file_GAMuT_time <- paste(Sys.Date(), "pvalue", "GAMuT_time", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
file_CCT_time <- paste(Sys.Date(), "pvalue", "CCT_time", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
file_SMAT_time <- paste(Sys.Date(), "pvalue", "SMAT_time", "adj", "dglm", Nsim, "pheno", Ngenes, sep = "_")
