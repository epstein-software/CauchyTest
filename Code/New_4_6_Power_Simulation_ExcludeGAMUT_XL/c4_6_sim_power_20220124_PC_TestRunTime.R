...
for (array.id in 1:dim(param_comb)[1]) {
  ...
  save(pval_SMAT_adj_dglm, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_name_SMAT_pvalue, ".RData", sep = ""))
  save(pval_SMAT_includeXsquare_adj_dglm, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_name_includeXsquare_SMAT_pvalue, ".RData", sep = ""))
  save(pval_CCT_adj_dglm, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_name_CCT_pvalue, ".RData", sep = ""))
  save(pval_includeXsquare_CCT_adj_dglm, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_name_includeXsquare_CCT_pvalue, ".RData", sep = ""))
  
  save(simulation_time, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_simulation_time, ".RData", sep = ""))
  save(SMAT_time, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_SMAT_time, ".RData", sep = ""))
  save(SMAT_includeXsquare_time, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_includeXsquare_SMAT_time, ".RData", sep = ""))
  save(CCT_time, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_CCT_time, ".RData", sep = ""))
  save(CCT_includeXsquare_time, 
       file = paste("Result/c4_6_sim_power_20220124_PC_TestRunTime/", file_includeXsquare_CCT_time, ".RData", sep = ""))
