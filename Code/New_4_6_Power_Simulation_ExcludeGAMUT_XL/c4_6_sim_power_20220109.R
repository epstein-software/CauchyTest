...
save(pval_SMAT_adj_dglm, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_name_SMAT_pvalue, ".RData", sep = ""))
save(pval_SMAT_includeXsquare_adj_dglm, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_name_includeXsquare_SMAT_pvalue, ".RData", sep = ""))
save(pval_CCT_adj_dglm, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_name_CCT_pvalue, ".RData", sep = ""))
save(pval_includeXsquare_CCT_adj_dglm, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_name_includeXsquare_CCT_pvalue, ".RData", sep = ""))

save(simulation_time, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_simulation_time, ".RData", sep = ""))
save(SMAT_time, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_SMAT_time, ".RData", sep = ""))
save(SMAT_includeXsquare_time, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_includeXsquare_SMAT_time, ".RData", sep = ""))
save(CCT_time, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_CCT_time, ".RData", sep = ""))
save(CCT_includeXsquare_time, 
     file = paste("Result/New_4_6_Power_Simulation_ExcludeGAMUT_20220109/", file_includeXsquare_CCT_time, ".RData", sep = ""))
