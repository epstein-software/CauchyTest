...
for (index in 1:nrow(param_comb_plot1)) {
  ...
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_delta/", index, "_thre_5_minus_2_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_val, ".pdf", sep = ""),
  ...
  ggplot(temp_df_F, 
    ...
    facet_wrap(~ Nsub + Npheno, ncol = 5) + 
    theme(strip.text = element_text(size=12, face="bold", color="darkblue"))
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_delta/", index, "_thre_5_minus_6_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_val, ".pdf", sep = ""),
         width = 40, height = 20, units = "cm")
  ...
  ggplot(temp_df_F, 
    ...
    facet_wrap(~ Nsub + Npheno, ncol = 5) + 
    theme(strip.text = element_text(size=12, face="bold", color="darkblue"))
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_delta/", index, "_thre_1_minus_6_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_val, ".pdf", sep = ""),
         width = 40, height = 20, units = "cm")
  ...
  ggplot(temp_df_F, 
    ...
    facet_wrap(~ Nsub + Npheno, ncol = 5) + 
    theme(strip.text = element_text(size=12, face="bold", color="darkblue"))
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_delta/", index, "_thre_1_minus_7_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_val, ".pdf", sep = ""),
         width = 40, height = 20, units = "cm")
...
for (index in 1:nrow(param_comb_plot2)) {
  ...
  ggplot(temp_df_F, 
    ...
    facet_wrap(~ Nsub + Npheno, ncol = 5) + 
    theme(strip.text = element_text(size=12, face="bold", color="darkblue"))
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_sparsity/", index, "_thre_5_minus_2_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_select_val, ".pdf", sep = ""),
         width = 40, height = 20, units = "cm")
  ...
  ggplot(temp_df_F, 
    ...
    facet_wrap(~ Nsub + Npheno, ncol = 5) + 
    theme(strip.text = element_text(size=12, face="bold", color="darkblue"))
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_sparsity/", index, "_thre_5_minus_6_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_select_val, ".pdf", sep = ""),
         width = 40, height = 20, units = "cm")
  ...
  ggplot(temp_df_F, 
    ...
    facet_wrap(~ Nsub + Npheno, ncol = 5) + 
    theme(strip.text = element_text(size=12, face="bold", color="darkblue"))
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_sparsity/", index, "_thre_1_minus_6_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_select_val, ".pdf", sep = ""),
         width = 40, height = 20, units = "cm")
  ...
  ggplot(temp_df_F, 
    ...
    facet_wrap(~ Nsub + Npheno, ncol = 5) + 
    theme(strip.text = element_text(size=12, face="bold", color="darkblue"))
  ggsave(paste("Analysis/Power_Simulation_Dec2021/plot/fix_gamma_sparsity/", index, "_thre_1_minus_7_", "power_simulation_gamma_", gamma_val, "_delta_delta_val_", delta_select_val, ".pdf", sep = ""),
         width = 40, height = 20, units = "cm")
