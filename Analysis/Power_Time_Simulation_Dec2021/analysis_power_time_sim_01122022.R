...
ggsave(paste("Analysis/Power_Time_Simulation_Dec2021/Simulation_Time_01122022.pdf", sep = ""),
...
write_csv(temp_df_F %>% select(-Npheno_F), 
          "Analysis/Power_Time_Simulation_Dec2021/Simulation_Time_01122022.csv")
...
ggsave(paste("Analysis/Power_Time_Simulation_Dec2021/Simulation_Time_wo_sparsity_01122022.pdf", sep = ""),
       width = 40, height = 20, units = "cm")

temp_df_F$`Time for 10,000 Simulations in Hour` = temp_df_F$Ave_Time*10000/3600
names(temp_df_F)[names(temp_df_F)=="Ave_Time"] = "Average time per simulation in second"
write_csv(temp_df_F %>% select(-Npheno_F), 
          "Analysis/Power_Time_Simulation_Dec2021/Simulation_Time_wo_sparsity_01122022.csv")
